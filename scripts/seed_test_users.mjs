...
const ensureDepartment = async (name, description) => {
...
const ensureCommittee = async (name, description) => {
...
const ensureMember = async (payload) => {
...
const ensureDepartmentMember = async (departmentId, memberId, role) => {
...
const ensureCommitteeMember = async (committeeId, memberId, role) => {
...
const buildGroupPermissions = async () => {
  ...
  return { groups, roles, rolePerms, groupPerms };
};

const findGroupByName = (groups, needle) => {
  const n = needle.toLowerCase();
  return groups.find((g) => (g.name || "").toLowerCase().includes(n)) || null;
};

const pickGroupByPermissions = (groups, groupPerms, required, preferredName) => {
...
const pickRoleCover = (roles, rolePerms, required) => {
...
const ensureGroup = async (name, description) => {
...
const ensureGroupRoles = async (groupId, roleIds) => {
...
const ensureUserGroups = async (userId, groupIds) => {
