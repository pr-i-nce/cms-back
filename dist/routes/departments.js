...
const resolveDepartmentScope = async (userId) => {
...
const ensureDepartmentScope = async (userId, departmentId) => {
...
departmentsRouter.get("/", requireAuth, requirePermission("DEPARTMENT_UPDATE"), async (req, res) => {
...
departmentsRouter.get("/roles", requireAuth, requirePermission("DEPARTMENT_UPDATE"), async (_req, res) => {
...
departmentsRouter.get("/heads", requireAuth, requirePermission("DEPARTMENT_UPDATE"), async (req, res) => {
    const headRoles = env.departmentHeadRoles;
    if (!headRoles.length) {
...
departmentsRouter.post("/", requireAuth, requirePermission("DEPARTMENT_CREATE"), async (req, res) => {
...
departmentsRouter.get("/:id", requireAuth, requirePermission("DEPARTMENT_UPDATE"), async (req, res) => {
...
departmentsRouter.put("/:id", requireAuth, requirePermission("DEPARTMENT_UPDATE"), async (req, res) => {
    const actor = req.userId || "system";
    const id = req.params.id;
    if (req.userId) {
        const allowed = await ensureDepartmentScope(req.userId, id);
...
departmentsRouter.post("/:id/deactivate", requireAuth, requirePermission("DEPARTMENT_DEACTIVATE"), async (req, res) => {
    const actor = req.userId || "system";
    const id = req.params.id;
    if (req.userId) {
        const allowed = await ensureDepartmentScope(req.userId, id);
...
departmentsRouter.get("/:id/members", requireAuth, requirePermission("DEPARTMENT_UPDATE"), async (req, res) => {
    const id = req.params.id;
    if (req.userId) {
        const allowed = await ensureDepartmentScope(req.userId, id);
        if (!allowed) {
    ...
    const rows = assignments
        ...
        if (!member)
            return null;
        if (q && !(member.name || "").toLowerCase().includes(q))
            return null;
...
departmentsRouter.post("/:id/members", requireAuth, requirePermission("DEPT_MEMBER_ADD"), async (req, res) => {
    const actor = req.userId || "system";
    const id = req.params.id;
    if (req.userId) {
        const allowed = await ensureDepartmentScope(req.userId, id);
...
departmentsRouter.delete("/:id/members/:memberId", requireAuth, requirePermission("DEPT_MEMBER_REMOVE"), async (req, res) => {
...
departmentsRouter.get("/members/assignments", requireAuth, requirePermission("DEPARTMENT_UPDATE"), async (req, res) => {
    const scope = req.userId ? await resolveDepartmentScope(req.userId) : null;
