...
smsRouter.get("/", requireAuth, requirePermission("SMS_VIEW"), async (req, res) => {
    ...
    let normalizedStatus = status || undefined;
    if (normalizedStatus) {
...
smsRouter.get("/templates", requireAuth, requirePermission("SMS_SEND"), (_req, res) => {
...
smsRouter.get("/segments", requireAuth, requirePermission("SMS_SEND"), async (_req, res) => {
    const data = await cached("sms:segments", env.cacheTtl.smsSegmentsMs, () => segments());
    res.json(ok(data, "OK", buildMeta()));
});
smsRouter.post("/send", requireAuth, requirePermission("SMS_SEND"), async (req, res) => {
...
smsRouter.post("/balance", requireAuth, requirePermission("SMS_VIEW"), async (_req, res) => {
...
smsRouter.post("/dlr", requireAuth, requirePermission("SMS_VIEW"), async (req, res) => {
