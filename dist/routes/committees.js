...
const resolveCommitteeScope = async (userId) => {
...
const ensureCommitteeScope = async (userId, committeeId) => {
...
committeesRouter.get("/", requireAuth, requireAnyPermission(["READ_ALL", "COMMITTEE_UPDATE"]), async (req, res) => {
...
committeesRouter.get("/roles", requireAuth, requireAnyPermission(["READ_ALL", "COMMITTEE_UPDATE"]), async (_req, res) => {
...
committeesRouter.get("/chairs", requireAuth, requireAnyPermission(["READ_ALL", "COMMITTEE_UPDATE"]), async (req, res) => {
    const chairRoles = env.committeeChairRoles;
...
committeesRouter.post("/", requireAuth, requirePermission("COMMITTEE_CREATE"), async (req, res) => {
...
committeesRouter.get("/:id", requireAuth, requireAnyPermission(["READ_ALL", "COMMITTEE_UPDATE"]), async (req, res) => {
...
committeesRouter.put("/:id", requireAuth, requirePermission("COMMITTEE_UPDATE"), async (req, res) => {
    const actor = req.userId || "system";
    const id = req.params.id;
    if (req.userId) {
        const allowed = await ensureCommitteeScope(req.userId, id);
...
committeesRouter.post("/:id/deactivate", requireAuth, requirePermission("COMMITTEE_DEACTIVATE"), async (req, res) => {
    const actor = req.userId || "system";
    const id = req.params.id;
    if (req.userId) {
        const allowed = await ensureCommitteeScope(req.userId, id);
...
committeesRouter.get("/:id/members", requireAuth, requirePermission("COMMITTEE_UPDATE"), async (req, res) => {
    const id = req.params.id;
    if (req.userId) {
        const allowed = await ensureCommitteeScope(req.userId, id);
        if (!allowed) {
...
committeesRouter.post("/:id/members", requireAuth, requirePermission("COMMITTEE_MEMBER_ADD"), async (req, res) => {
    const actor = req.userId || "system";
    const id = req.params.id;
    if (req.userId) {
        const allowed = await ensureCommitteeScope(req.userId, id);
...
committeesRouter.delete("/:id/members/:memberId", requireAuth, requirePermission("COMMITTEE_MEMBER_REMOVE"), async (req, res) => {
